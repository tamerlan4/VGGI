...
document.getElementById('R1').addEventListener('change', update);
document.getElementById('R2').addEventListener('change', update);
document.getElementById('height').addEventListener('change', update);
document.getElementById('segments').addEventListener('change', update);
document.getElementById('stacks').addEventListener('change', update);
